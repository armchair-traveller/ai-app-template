...
const queryRewriterSchema = z.object({
	plan: z.string().describe('A detailed plan of how to approach answering the question.'),
	queries: z.array(z.string()).describe('A list of search queries to execute in parallel.')
});
